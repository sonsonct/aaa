...
const Suabot = () => {
    ...
    const getList = () => {
        return fetch('https://63772cd181a568fc250e07f2.mockapi.io/api_sua_bot')
        ...
        <View style={styles.container}>
            <View style={{flexDirection:'row'}}>
                <Image
                    ...
                    source={require('../img/suabot.webp')}
                    resizeMode="contain"
                />
                <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#00ab90',paddingTop:55 }}>SỮA BỘT</Text>
            </View>
